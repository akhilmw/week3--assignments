...
When the user signs up, they should get back a jwt that is vd for 1 hour. 
They should then send justali that jwt vs sending username and password to the authenticated routes.
...
### Admin Routes:
 ...
 - POST /admin/courses -> DONE
   ...
   Output: { messag e created successfully', courseId: 1 }
